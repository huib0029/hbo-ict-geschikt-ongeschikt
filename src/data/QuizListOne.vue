  ...
  questions: [
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text:
            "Bepalen wat de impact hiervan is en kijken of deze uitgesloten kan worden van verder onderzoek",
          correct: true
        },
        { text: "Geen van bovenstaande" }
      ]
...
export const userResponseSkelaton = Array(quiz.questions.length).fill(null);
</script>